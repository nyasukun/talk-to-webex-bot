...
enum WorkerRequest {
    static func diagnose(settings: Settings) -> [String: Any] {
        ["language": settings.language.rawValue, "action": "diagnose", "model": settings.asrModelPath,
    ...
    static func transcribe(audio: String, settings: Settings, verifyInline: Bool) -> [String: Any] {
        var request: [String: Any] = ["language": settings.language.rawValue, "action": "transcribe", "audio": audio, "model": settings.asrModelPath,
    ...
    static func verifySpeaker(audio: String, settings: Settings) -> [String: Any] {
        ["language": settings.language.rawValue, "action": "verify_speaker", "audio": audio,
         "reference_audio": settings.speakerAudioPath,
